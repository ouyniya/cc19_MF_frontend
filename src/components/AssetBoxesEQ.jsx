      ...
      <div>
        ...
        >
          <div className="sticky top-0 flex h-screen items-center overflow-hidden">
            ...
            <div className="absolute -z-10 opacity-20 bottom-[170px] -left-[250px]">
              <img
                src="src/assets/cloud.png"
                alt="cloud"
