        ...
        <div className="collapse-content">
          <div className="md:flex gap-5 m-auto p-5">
            <div className="card bg-base-100 w-[300px] sm:w-full shadow-xl md:basis-1/3 mb-[24px]">
              <span className="ribbon absolute -top-[12px] -left-[12px] text-center rounded-full bg-[var(--blue)] text-white p-[8px]">
                ขั้นตอนที่ 1
              </span>
              ...
              <div className="card-body">
                ...
                <p>
                  ระบุประเภทและนโยบายการลงทุนของกองทุนรวม จากนั้น ระบุเงื่อนไข
                  เช่น ชื่อบริษัทหลักทรัพย์ จัดการกองทุน (บลจ.), การจ่ายปันผล,
                  ระดับความเสี่ยง เป็นต้น
                </p>
              </div>
            </div>
            <div className="card bg-base-100 w-[300px] sm:w-full shadow-xl md:basis-1/3 mb-[24px]">
              ...
              <div className="card-body">
                ...
                <p>
                  ศึกษาข้อมูลจากเอกสาร Fund Fact Sheet
                  และเปรียบเทียบผลการดำเนินงาน ความเสี่ยง ค่าธรรมเนียม
                  ทรัพย์สินที่ลงทุน เป็นต้น กับ กองทุนที่อยู่ในกลุ่มเดียวกัน
                </p>
              </div>
            </div>
            <div className="card bg-base-100 w-[300px] sm:w-full shadow-xl md:basis-1/3 mb-[24px]">
              ...
              <div className="card-body">
                ...
                <p>
                  พิจารณาปัจจัยแวดล้อมอื่นๆ เช่น สภาพเศรษฐกิจขณะนั้น
                  รวมถึงขนาดของกองทุนที่อาจส่งผลต่อต้นทุนและสภาพคล่องของกองทุนนั้นๆ
                  ได้ เป็นต้น
                </p>
              </div>
            </div>
